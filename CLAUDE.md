...
1. **以中文溝通。** 所有回覆一律用中文；keyword、專有名詞（如 ADR、Drizzle、lob_pct）可維持英文，不必硬翻。

2. **開 subagent 時要交代規則。** 若要開 subagent，必須在指示裡明確要求該 subagent 也遵照本 `CLAUDE.md` 的所有規則（含中文溝通與各節工作流程）。
